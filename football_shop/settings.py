...
# Database
# Production: gunakan PostgreSQL, Development: gunakan SQLite
if PRODUCTION:
    DATABASES = {
        'default': {
...
if DEBUG:
    STATICFILES_DIRS = [
        BASE_DIR / 'static',   # folder static saat development
    ]
else:
    STATIC_ROOT = BASE_DIR / 'static'   # folder static saat production
